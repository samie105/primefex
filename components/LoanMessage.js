...
export default function LoanMessage() {
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="bg-white rounded-2xl shadow-lg lg:px-10 md:px-10 px-5 py-12 mx-5 md:mx-36 sm:mx-28  lg:mx-56">
        ...
        <p className="text-base mb-6 px-5 text-gray-700 font-semibold">
          ...
          the standard of that amount. We've approved you for the loan of $${loanby20} to pay $${payback} in ${formData.loanDuration} months, you'll pay $${formData.monthlyPayment} every month with an interest rate of ${formData.interest}% per month.  Our Customer Care Consultant will reach you soon`}
        </p>
