...
const MainFAQ = () => {
  ...
  const faqData = [
    ...
    {
      question: "When will I know if my MyQuickLoan is approved?",
      answer:
    ...
    },
    {
      ...
      answer:
        ...
        "MyQuickLoan will transfer the money to your bank by the end of the business day on the same day the approved loan was accepted by you.* Your bank could make that money available to you immediately thereafter. If you do not see your funds by the end of the day, be sure to contact your bank for specifics.\n\n" +
        "Monday through Thursday between 11:30 a.m. CT and 8 p.m. CT\n\n" +
        "MyQuickLoan will transfer your funds to your bank overnight.\n" +
    ...
    },
    {
      ...
      answer:
        ...
        "For example, on your first MyQuickLoan, your APR is 490%. If you borrow $600 and choose a bi-weekly payment schedule of ten payments over five months, then you would pay approximately $775 in finance charges, for a total payback of $1,375. (This assumes that your first payment occurs 14 days after the loan is funded, and you make all scheduled payments in full and on time.)",
    },
    {
      question: "What fees are associated with a MyQuickLoan?",
      answer:
        "There are no hidden fees associated with a MyQuickLoan. The fees that you are responsible for are outlined when you apply for a MyQuickLoan and in your loan documents.\n\n" +
        ...
        "Additionally, you may be charged $10 for any returned checks as an NSF fee. MyQuickLoan does not charge an origination fee.",
    },
    {
      question: "How do MyQuickLoans compare to payday loans?",
      answer:
        "MyQuickLoans and payday loans are completely different. MyQuickLoans are short-term installment loans, which means you pay back your loan over time. With a MyQuickLoan, you choose how long you want to pay the loan back, up to ten months. Plus, you can pay your loan off early with no prepayment penalties.\n\n" +
    ...
    {
      question: "How do I decide if a MyQuickLoan is right for me?",
      answer:
        "Only you can decide if a MyQuickLoan is right for you.\n\n" +
        "It is important to note that a MyQuickLoan is an expensive form of credit and is intended only for short-term financial needs. MyQuickLoans are designed to help you deal with emergencies such as rent, medical bills, car repairs, and expenses related to your job. MyQuickLoans are not intended to solve longer-term credit or other financial needs, and alternative forms of credit may be better for you, including borrowing from a friend or relative, using a credit card cash advance, taking out a personal loan, or using a home equity loan or savings.",
    },
    {
      ...
      answer:
        ...
        "97% of MyQuickLoan customers choose to make their payments using ACH because it is a convenient way to make loan payments, and it can also save you money over the life of your loan by helping you avoid missed payments.\n\n" +
    ...
    {
      question: "How do I contact MyQuickLoan?",
      answer:
        "That’s easy! Send an email to contact@myquickloan.com. Our hours of operation are: Monday - Friday 7 a.m. - 8 p.m. CT and Saturday 9 a.m. - 6 p.m. CT.",
    },
    {
      question: "What happens if my loan doesn’t go to the right bank account?",
      answer:
        "We deposit your loan using the bank account information you provided us during the application process. When you make us aware that funds have not been received, it takes five to seven business days for a bank to return the funds to MyQuickLoan so we can deposit the funds into the correct account.",
    },
    {
