...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "To be eligible for a loan from MyQuickLoan, you must be at least 18 years old, have a steady source of income, and meet our creditworthiness requirements. Additional criteria may apply depending on the type and amount of the loan.",
  },
  {
    question: "What if I have bad credit?",
    answer:
      "Most lenders shy away from lower credit scores that rely on prior loan and credit card history available from the 3 credit bureaus. However, we reach beyond the bureaus and scores using an advanced algorithm to spot real people with the real intent to pay, despite low credit scores, past credit problems, or lacking credit history.If you have a bad credit score, or have not borrowed before, MyQuickLoan can help you get money fast. No collateral is required.",
  },
...
export default function FAQ() {
  ...
  return (
    <div className="mt-14 ">
      <div className="faq-container bg-blue-600 py-5 px-4 sm:px-8 md:px-16 lg:px-24 opacity-75">
